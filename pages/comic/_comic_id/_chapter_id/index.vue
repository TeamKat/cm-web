<template>
  <div>
    <div class="container">
        ...
        <div class="detail">
          ...
          <div class="author">
            <div class="info-block">
              ...
              <info-author
                :values="[{key: 'lapham', name: 'lapham'}, {key: 'johnson', name: 'johnson'}]"></info-author>
            </div>
            <div class="info-block">
              <a-icon type="eye"/>
          ...
          <div class="info-block">
            ...
            <info-link :url="'/authors/johnson/234'">Chapter 200</info-link>
          </div>
      ...
      <divider class="description-divider"/>
    ...
    <div class="container" style="background: unset; padding: unset">
      <div class="cp-control">
        ...
        <a-dropdown class="dropdown" placement="bottomCenter">
          <a-button>{{ 200 }}</a-button>
          <a-menu slot="overlay">
            <a-menu-item v-for="(item, index)  in new Array(200)" :key="index">
              <locale-link :url="''">{{ 200 - index }}</locale-link>
            </a-menu-item>
          </a-menu>
        </a-dropdown>
        <span class="next">
...
export default {
  ...
  components: {
    LocaleLink,
    LazyImg, CmPage, CmImg, InfoRate, InfoLink, InfoAuthor, CpList, CmTitle, Poster, Divider, CmSlider, CmList, SgList
  },
  head() {
    return {
...
@media screen and (max-width: 768px) {
  .container {
    ...
    .description-divider, .description-layout {
      display: none;
    }
